...
是否表达了对AI发展的个人思考与态度？是否能结合实际做出理性判断？""",
            "可以先从就业、教育、医疗三个方面分别展开，最后再结合伦理和未来展望。"
        ),
...
是否有批判性思维？是否从个人经验出发，展示对现象的深刻认知？""",
            "先从“内卷”概念出发，结合社会资源分配和个人应对策略进行分析。"
        ),
...
是否从中有反思与改进？是否能从压力中提炼出学习与成长的契机？""",
            "可结合个人经历谈情绪识别，并介绍常见的情绪管理与寻求支持的方法。"
        ),
...
是否对实施方式、评估机制有考虑？是否展现教育理念和实际价值？""",
            "可先说明目标学生群体与需求，然后介绍课程内容与教学方法，最后谈评估机制。"
        ),
...
是否联系到职业转型、技能更新等实际场景？体现目标感与战略眼光。""",
            "先阐述“终身学习”概念，再结合职场需求谈方法与路径，最后举例说明。"
        ),
